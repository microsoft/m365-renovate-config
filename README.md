...
```json
{
  "extends": [
    "config:recommended",
    "github>microsoft/m365-renovate-config:dependencyDashboardMajor#v2.7.6",
    "github>microsoft/m365-renovate-config:groupReact#v2.7.6",
    "github>microsoft/m365-renovate-config:newConfigWarningIssue#v2.7.6",
    "github>microsoft/m365-renovate-config:pinActions#v2.7.6"
  ],
...
{
  "extends": [
    "github>microsoft/m365-renovate-config#v2.7.6",
    "github>microsoft/m365-renovate-config:beachballPostUpgrade#v2.7.6"
  ]
}
```
...
```json
{
  "extends": [
    "group:monorepos",
    "group:recommended",
    "github>microsoft/m365-renovate-config:groupD3#v2.7.6",
    "github>microsoft/m365-renovate-config:groupEslint#v2.7.6",
    "github>microsoft/m365-renovate-config:groupFixtureUpdates#v2.7.6",
    "github>microsoft/m365-renovate-config:groupFluent#v2.7.6",
    "github>microsoft/m365-renovate-config:groupJest#v2.7.6",
    "github>microsoft/m365-renovate-config:groupLageBackfill#v2.7.6",
    "github>microsoft/m365-renovate-config:groupNodeMajor#v2.7.6",
    "github>microsoft/m365-renovate-config:groupReact#v2.7.6",
    "github>microsoft/m365-renovate-config:groupRollup#v2.7.6",
    "github>microsoft/m365-renovate-config:groupYargs#v2.7.6"
  ]
}
```
