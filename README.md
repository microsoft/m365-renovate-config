...
```json
{
  "extends": [
    "config:recommended",
    "github>microsoft/m365-renovate-config:dependencyDashboardMajor#v2.8.1",
    "github>microsoft/m365-renovate-config:groupReact#v2.8.1",
    "github>microsoft/m365-renovate-config:newConfigWarningIssue#v2.8.1",
    "github>microsoft/m365-renovate-config:pinActions#v2.8.1"
  ],
...
{
  "extends": [
    "github>microsoft/m365-renovate-config#v2.8.1",
    "github>microsoft/m365-renovate-config:beachballPostUpgrade#v2.8.1"
  ]
}
```
...
```json
{
  "extends": [
    "group:monorepos",
    "group:recommended",
    "github>microsoft/m365-renovate-config:groupActions#v2.8.1",
    "github>microsoft/m365-renovate-config:groupD3#v2.8.1",
    "github>microsoft/m365-renovate-config:groupEslint#v2.8.1",
    "github>microsoft/m365-renovate-config:groupFixtureUpdates#v2.8.1",
    "github>microsoft/m365-renovate-config:groupFluent#v2.8.1",
    "github>microsoft/m365-renovate-config:groupJest#v2.8.1",
    "github>microsoft/m365-renovate-config:groupLageBackfill#v2.8.1",
    "github>microsoft/m365-renovate-config:groupNodeMajor#v2.8.1",
    "github>microsoft/m365-renovate-config:groupReact#v2.8.1",
    "github>microsoft/m365-renovate-config:groupRollup#v2.8.1",
    "github>microsoft/m365-renovate-config:groupYargs#v2.8.1"
  ]
}
```
